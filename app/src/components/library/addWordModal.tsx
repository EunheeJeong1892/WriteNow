  ...
  const handleSave = async () => {
    ...
    if (word && desc && selectedFile) {
      ...
      try {
        ...
        await fetch(
          "https://gpzyo7nv2d.execute-api.ap-northeast-2.amazonaws.com/InsertWord",
          {
            method: "POST",
            headers: {
        ...
        setWordsAtom((prevState: WordProps[]) => [...prevState, newWord]);
      ...
      <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
        <div className={styles.addWordModal}>
          <div className={styles.addWordModalHeader}>
            ...
            <div onClick={handleSave} className={styles.addWordModalHeaderSave}>
              저장
            </div>
          </div>
          <div className={styles.addWordModalBody}>
            <div className={styles.addWordModalInputWrapper}>
              <input
                ...
                placeholder={`단어`}
                ref={wordDiv}
                className={styles.addWordModalInput}
              />
            </div>
            <div className={styles.addWordModalInputWrapper}>
              <textarea
                ...
                ref={descDiv}
                rows={3}
                className={styles.addWordModalTextArea}
              ></textarea>
            </div>
          </div>
          <div>
            ...
            {selectedFile ? (
              ...
              <div
                onClick={handleClick}
                className={styles.addWordModalFileUpload}
              >
